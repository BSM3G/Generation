...
class Job_Holder():
    ...
    def print_overview(self, use_id):
        ...
        for filename, tmp_array in self.jobs_overview.iteritems():
            ...
            self.stdscr.addstr(cur_line, 0, write_str, curses.color_pair(self.colors[tmp_array[0]]) | curses.A_BOLD | curses.A_UNDERLINE)
            cur_line += 1
        return cur_line
    ...
    def print_all(self, use_id):
        ...
        for filename, job_array in self.all_jobs.iteritems():
            ...
            for array_id, tmp_array in job_array.iteritems():
                ...
                self.stdscr.addstr(cur_line, 0, write_str, curses.color_pair(self.colors[tmp_array["job_state"]]) | curses.A_BOLD)
                cur_line += 1
            ...
            self.stdscr.addstr(start_job, 0, id_line, curses.color_pair(self.colors[self.jobs_overview[filename][0]]) | curses.A_BOLD)
        return cur_line
