...
cd /uscms_data/d2/DUMMY/CMSSW_7_4_15/src/
...
cp -r /uscms_data/d2/DUMMY/CMSSW_7_4_15/src/Analyzer/BSM3G_TNT_MainAnalyzer .

# "cd" in to the analysos code directory, e.g:
# cd muonToTauFakeRate
cd BSM3G_TNT_MainAnalyzer/ANALYSISDIRECTORY
...
xrdcp -sf $_CONDOR_SCRATCH_DIR/BSM3G_TNT_MainAnalyzer/ANALYSISDIRECTORY/$outputfile root://cmseos.fnal.gov//store/user/DUMMY/TEMPDIRECTORY/$outputdir
